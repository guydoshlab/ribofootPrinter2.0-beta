...
metagene.main(variables["roccnames"],variables["kind"],variables["weighting"],variables["genethresh"],variables["range5"],variables["range3"],variables["subsetlist"],variables["outfile"])