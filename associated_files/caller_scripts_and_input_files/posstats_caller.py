...
# This caller script opens the txt input file, parses it, and for each rocc file specified, calls posstats.
...
posstats.main(variables["roccnames"],variables["motif"],variables["kind"],variables["frame"],variables["genethresh"],variables["pkwindow"],variables["shift"],variables["UTRmode"],variables["outfile"])
