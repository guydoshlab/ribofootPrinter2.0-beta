...
# This caller script opens the txt input file, parses it, and for each rocc file specified, calls writegene2.
...
writegene2.main(variables["roccnames"],variables["genenames"],variables["outfile"])